...
print $form->selectyesno("DELIVERYADDRESS_SHOW_PHONE",!empty($conf->global->DELIVERYADDRESS_SHOW_PHONE)?$conf->global->DELIVERYADDRESS_SHOW_PHONE:'',1);
...
print $form->selectyesno("DELIVERYADDRESS_SHOW_EMAIL",!empty($conf->global->DELIVERYADDRESS_SHOW_EMAIL)?$conf->global->DELIVERYADDRESS_SHOW_EMAIL:'',1);
print '<input type="submit" class="button" value="'.$langs->trans("Modify").'">';
print '</form>';
print '</td></tr>';
