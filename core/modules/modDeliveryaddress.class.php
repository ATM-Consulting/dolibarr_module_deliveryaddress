...
class modDeliveryaddress extends DolibarrModules
{
    ...
    public function __construct($db)
    {
        ...
        $this->module_parts = array(
            ...
            'hooks' => array('ordersuppliercard','ordercard')
        ...
        $this->langfiles = array("deliveryaddress@deliveryaddress"); // langfiles@mymodule
        // Constants
    ...
    {
        return $this->_load_tables('/deliveryaddress/sql/');
    }
}